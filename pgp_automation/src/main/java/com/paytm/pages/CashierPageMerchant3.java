...
public class CashierPageMerchant3 extends CashierPage {
    public CashierPageMerchant3() {
        super("Merchant Theme Cashier Page");
    }

    @Override
    public Button buttonPGPayNow() {
        return new Button(By.cssSelector(".cards-tabs:not(.hide) .content.active input[value='Pay now']"), getPageName(), "buttonPGPayNow");
    }
    ...
    public CheckBox walletBalanceCheck() {
        return new CheckBox(By.cssSelector(".walletSwitchBox .amt"), getPageName(), "walletBalanceCheck");
    }
    ...
    @Override
    public RadioButton radioBtnSavedCard(String cardId) {
        return null;
    }
