...
public class EmiDetail {
    ...
    public EmiDetail withChannelCode(String channelCode) {
        this.channelCode = channelCode;
        return this;
    }
    ...
    public EmiDetail withChannelName(String channelName) {
        this.channelName = channelName;
        return this;
    }
    ...
    public EmiDetail withEmiType(String emiType) {
        this.emiType = emiType;
        return this;
    }
    ...
    public EmiDetail withIconUrl(String iconUrl) {
        this.iconUrl = iconUrl;
        return this;
    }
    ...
    public EmiDetail withEmiChannelInfos(List<EmiChannelInfo> emiChannelInfos) {
        this.emiChannelInfos = emiChannelInfos;
        return this;
    }
    ...
    public EmiDetail withMultiItemEmiSupported(Boolean multiItemEmiSupported) {
        this.multiItemEmiSupported = multiItemEmiSupported;
        return this;
    }
