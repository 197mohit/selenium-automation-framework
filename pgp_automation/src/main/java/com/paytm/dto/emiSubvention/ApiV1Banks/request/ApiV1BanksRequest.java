...
public class ApiV1BanksRequest implements Serializable {

    private ApiV1BanksRequest(Builder builder) {
        this.head = new Head()
    ...
    public static class Builder {
        ...
        public ApiV1BanksRequest build() {
            ApiV1BanksRequest a = new ApiV1BanksRequest(this);
    ...
    @JsonProperty("head")
    public ApiV1BanksRequest setHead(Head head) {
        this.head = head;
        return this;
    }
    ...
    @JsonProperty("body")
    public ApiV1BanksRequest setBody(Body body) {
        this.body = body;
        return this;
    }
    ...
    @JsonAnySetter
    public ApiV1BanksRequest setAdditionalProperty(String name, Object value) {
