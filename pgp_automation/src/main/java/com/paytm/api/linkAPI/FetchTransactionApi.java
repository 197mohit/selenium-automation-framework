...
public class FetchTransactionApi extends BaseApi {
    String request="{\n" +
            "\"head\": {\n" +
    ...
    public FetchTransactionApi() {
        setMethod(MethodType.POST);
        getRequestSpecBuilder().setContentType(ContentType.JSON);
        getRequestSpecBuilder().setAccept(ContentType.JSON);
        getRequestSpecBuilder().setBaseUri(LocalConfig.PGP_HOST);
        getRequestSpecBuilder().setBasePath(Constants.PGPAPIResourcePath.FETCH_TRANSACTION_LINK);
    ...
    public FetchTransactionApi buildRequest(String mid, Integer linkId,String searchStartDate,String searchEndDate){
