...
/**
 * GET product details ({@code /api/store/products/{productId}}).
 * When {@link Builder#pgmid(String)} is set, path becomes {@code /api/store/pgmid/{pgmid}/products/{productId}}.
 */
public class DealsStoreProductDetails extends BaseApi {
    ...
    private DealsStoreProductDetails(Builder b) {
        setMethod(MethodType.GET);
        String base = b.baseUri != null ? b.baseUri : LocalConfig.PLE_DEALS_BASE_URL;
        getRequestSpecBuilder().setBaseUri(base);
        String path = b.pgmid != null && !b.pgmid.isEmpty()
                ? "/api/store/pgmid/" + b.pgmid + "/products/" + b.productId
                : "/api/store/products/" + b.productId;
        ...
        if (b.ifNoneMatch != null && !b.ifNoneMatch.isEmpty()) {
            getRequestSpecBuilder().addHeader("if-none-match", b.ifNoneMatch);
        }
    ...
    public static final class Builder {
        ...
        /** Optional; when set, path becomes {@code /api/store/pgmid/{pgmid}/products/{productId}}. */
        ...
        /** ETag from a previous response; sends {@code If-None-Match} for conditional GET. */
        ...
        public DealsStoreProductDetails build() {
            ...
            return new DealsStoreProductDetails(this);
        }
    }
}
