...
/** GET EMI order summary for a link / order id ({@code /api/emi/pgmid/{pgmid}/orderSummary/{orderId}}). */
public class DealsEmiOrderSummary extends BaseApi {

    private static final String PATH_TEMPLATE = "/api/emi/pgmid/%s/orderSummary/%s";
    ...
    private DealsEmiOrderSummary(Builder b) {
        setMethod(MethodType.GET);
        String base = b.baseUri != null ? b.baseUri : LocalConfig.PLE_DEALS_BASE_URL;
        getRequestSpecBuilder().setBaseUri(base);
        getRequestSpecBuilder().setBasePath(String.format(PATH_TEMPLATE, b.pgmid, b.orderId));
        ...
        getRequestSpecBuilder().addQueryParam("state", b.state);
    ...
    public static final class Builder {
        ...
        public DealsEmiOrderSummary build() {
            ...
            return new DealsEmiOrderSummary(this);
        }
    }
}
