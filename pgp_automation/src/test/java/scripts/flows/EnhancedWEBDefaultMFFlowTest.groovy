...
import com.paytm.pages.CashierPageEnhancedWeb
...
class EnhancedWEBDefaultMFFlowTest extends TestSetUp implements DefaultMFFlowTest {

    OrderDTO.Builder orderBuilder() {
        new OrderDTO.Builder()
                .setTHEME('enhancedweb')
                .setCHANNEL_ID("WEB")
    ...
    CashierPage cashierPage = new CashierPageEnhancedWeb()
