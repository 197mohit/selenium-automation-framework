...
public class MaxPaymentLimitTaskForOldFlow extends PGPBaseTest {
    User user;
    String mid;
    ...
    public void MAXPAYMENTLIMIT_0031(@Optional("enhancedweb_revamp")String theme) throws Exception {
    ...
    public void MAXPAYMENTLIMIT_0032(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
    ...
    public void MAXPAYMENTLIMIT_0033(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"MAX_LINK_PAYMENTS_CHECK_DISABLED","ACTIVE","Y");
        linkHelper.setPrefOnMerchant(mid,"Disable_Payment_Link_Warning_Message","ACTIVE","N");
    ...
    public void MAXPAYMENTLIMIT_0034(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
    ...
    public void MAXPAYMENTLIMIT_0035(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"MAX_LINK_PAYMENTS_CHECK_DISABLED","ACTIVE","N");
        linkHelper.setPrefOnMerchant(mid,"Disable_Payment_Link_Warning_Message","ACTIVE","Y");
    ...
    public void MAXPAYMENTLIMIT_0036(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"MAX_LINK_PAYMENTS_CHECK_DISABLED","ACTIVE","N");
        linkHelper.setPrefOnMerchant(mid,"Disable_Payment_Link_Warning_Message","ACTIVE","Y");

        CreateNewLink createNewLink = new CreateNewLink().buildRequest(mid,"INVOICE","3");
        JsonPath withDrawJson1 = createNewLink.execute().jsonPath();
        String paymentLink = withDrawJson1.getString("body.longUrl");
        String linkId = withDrawJson1.getString("body.linkId");
        LinkPaymentLoginPage linkPaymentLoginPage = new LinkPaymentLoginPage();
    ...
    public void MAXPAYMENTLIMIT_0037(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"MAX_LINK_PAYMENTS_CHECK_DISABLED","ACTIVE","Y");
        linkHelper.setPrefOnMerchant(mid,"Disable_Payment_Link_Warning_Message","ACTIVE","Y");
    ...
    public void MAXPAYMENTLIMIT_0038(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"MAX_LINK_PAYMENTS_CHECK_DISABLED","ACTIVE","Y");
        linkHelper.setPrefOnMerchant(mid,"Disable_Payment_Link_Warning_Message","ACTIVE","Y");
    ...
    public void MAXPAYMENTLIMIT_0039(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"MAX_LINK_PAYMENTS_CHECK_DISABLED","ACTIVE","Y");
        linkHelper.setPrefOnMerchant(mid,"Disable_Payment_Link_Warning_Message","ACTIVE","Y");
    ...
    public void MAXPAYMENTLIMIT_0040(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"MAX_LINK_PAYMENTS_CHECK_DISABLED","ACTIVE","Y");
        linkHelper.setPrefOnMerchant(mid,"Disable_Payment_Link_Warning_Message","ACTIVE","N");
    ...
    public void MAXPAYMENTLIMIT_0041(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"MAX_LINK_PAYMENTS_CHECK_DISABLED","ACTIVE","Y");
        linkHelper.setPrefOnMerchant(mid,"Disable_Payment_Link_Warning_Message","ACTIVE","N");
    ...
    public void MAXPAYMENTLIMIT_0042(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"MAX_LINK_PAYMENTS_CHECK_DISABLED","ACTIVE","Y");
        linkHelper.setPrefOnMerchant(mid,"Disable_Payment_Link_Warning_Message","ACTIVE","N");
    ...
    public void MAXPAYMENTLIMIT_0043(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
    ...
    public void MAXPAYMENTLIMIT_0044(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
    ...
    public void MAXPAYMENTLIMIT_0045(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
    ...
    public void MAXPAYMENTLIMIT_0046(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"MAX_LINK_PAYMENTS_CHECK_DISABLED","ACTIVE","N");
        linkHelper.setPrefOnMerchant(mid,"Disable_Payment_Link_Warning_Message","ACTIVE","Y");
    ...
    public void MAXPAYMENTLIMIT_0047(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"MAX_LINK_PAYMENTS_CHECK_DISABLED","ACTIVE","N");
        linkHelper.setPrefOnMerchant(mid,"Disable_Payment_Link_Warning_Message","ACTIVE","Y");
    ...
    public void MAXPAYMENTLIMIT_0048(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_SD_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"MAX_LINK_PAYMENTS_CHECK_DISABLED","ACTIVE","N");
        linkHelper.setPrefOnMerchant(mid,"Disable_Payment_Link_Warning_Message","ACTIVE","Y");
    ...
    public void MAXPAYMENTLIMIT_0049(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        ...
        CreateNewLink createNewLink = new CreateNewLink().buildRequest(mid,"FIXED","3");
        int noOfMaxPaymentAllowed=2;
        createNewLink.setContext("body.maxPaymentsAllowed",noOfMaxPaymentAllowed);
        JsonPath withDrawJson1 = createNewLink.execute().jsonPath();
        String paymentLink = withDrawJson1.getString("body.longUrl");
    ...
    public void MAXPAYMENTLIMIT_0050(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_PGONLY_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"Limit_Max_Payment_On_Link","ACTIVE","Y");
        CreateNewLink createNewLink = new CreateNewLink().buildRequest(mid,"GENERIC","3");
        int noOfMaxPaymentAllowed=2;
        createNewLink.setContext("body.maxPaymentsAllowed",noOfMaxPaymentAllowed);
        JsonPath withDrawJson1 = createNewLink.execute().jsonPath();
        String paymentLink = withDrawJson1.getString("body.longUrl");
    ...
    public void MAXPAYMENTLIMIT_0051(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_PGONLY_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"Limit_Max_Payment_On_Link","ACTIVE","Y");
        CreateNewLink createNewLink = new CreateNewLink().buildRequest(mid,"INVOICE","3");
    ...
    public void MAXPAYMENTLIMIT_0052(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_PGONLY_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"Limit_Max_Payment_On_Link","ACTIVE","Y");
    ...
    public void MAXPAYMENTLIMIT_0053(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_PGONLY_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"Limit_Max_Payment_On_Link","ACTIVE","Y");
        SaveDefaultSettings saveDefaultSettings=new SaveDefaultSettings();
    ...
    public void MAXPAYMENTLIMIT_0054(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_PGONLY_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"Limit_Max_Payment_On_Link","ACTIVE","Y");
        SaveDefaultSettings saveDefaultSettings=new SaveDefaultSettings();
    ...
    public void MAXPAYMENTLIMIT_0055(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_PGONLY_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"Limit_Max_Payment_On_Link","ACTIVE","Y");
        SaveDefaultSettings saveDefaultSettings=new SaveDefaultSettings();
    ...
    public void MAXPAYMENTLIMIT_0056(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_PGONLY_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"Limit_Max_Payment_On_Link","ACTIVE","Y");
        SaveDefaultSettings saveDefaultSettings=new SaveDefaultSettings();
    ...
    public void MAXPAYMENTLIMIT_0057(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_PGONLY_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"Limit_Max_Payment_On_Link","ACTIVE","Y");
        SaveDefaultSettings saveDefaultSettings=new SaveDefaultSettings();
    ...
    public void MAXPAYMENTLIMIT_0058(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_PGONLY_OFFLINE.getId().toString());
    ...
    public void MAXPAYMENTLIMIT_0059(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_PGONLY_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"Limit_Max_Payment_On_Link","ACTIVE","N");
        SaveDefaultSettings saveDefaultSettings=new SaveDefaultSettings();
    ...
    public void MAXPAYMENTLIMIT_0060(@Optional("enhancedweb_revamp")String theme) throws Exception {
        LinkHelper linkHelper=new LinkHelper();
        setUserAndMId(Constants.MerchantType.LINK_PGONLY_OFFLINE.getId().toString());
        linkHelper.setPrefOnMerchant(mid,"Limit_Max_Payment_On_Link","ACTIVE","N");
        SaveDefaultSettings saveDefaultSettings=new SaveDefaultSettings();
