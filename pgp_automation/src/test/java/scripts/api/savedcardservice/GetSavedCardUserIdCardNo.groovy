...
@Owner('Deepak')
class GetSavedCardUserIdCardNo extends TestSetUp {

    def primary

    final def req = { userId, cardNumber ->
        given(
                new RequestSpecBuilder()
                        ...
                        .setBaseUri(PGP_HOST)
                        .setBasePath("/savedcardservice/savedCardService/v1/get/savedcard/cardNumber/${userId}/${cardNumber}")
                        .build()
        )
    }
