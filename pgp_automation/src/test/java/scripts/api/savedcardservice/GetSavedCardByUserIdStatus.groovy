...
@Owner('Deepak')
class GetSavedCardByUserIdStatus extends TestSetUp {

    def primary

    final def req = { userId, status ->
        given(
                new RequestSpecBuilder()
                        ...
                        .setBaseUri(PGP_HOST)
                        .setBasePath("/savedcardservice/savedCardService/v1/get/savedcard/userId/status/${userId}/${status}")
                        .build()
        )
    }
