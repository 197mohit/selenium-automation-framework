...
@Owner('Deepak')
class GetSavedCardBySSOTokenFlagOffTest extends GetSavedCardBySSOTokenTest {

    @BeforeClass
    void beforeClass() {
        String queryForExp = "UPDATE FF4J_FEATURES SET ENABLE = 0 WHERE FEAT_UID = '$SC_FETCH_FROM_PLATFORM_PERCENTAGE_FEATURE';";
