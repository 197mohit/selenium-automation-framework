...
@Owner('Deepak')
class PGGetSavedCardByUserIdTokenIdTokenTypeFlagOnTest extends PGGetSavedCardByUserIdTokenIdTokenTypeTest {

    @BeforeClass
    void beforeClass() {
        String queryForExp = "UPDATE FF4J_FEATURES SET EXPRESSION = 'grantedUserIds=ALL', ENABLE = 1 WHERE FEAT_UID = '$SC_FETCH_FROM_PLATFORM_FOR_USER_ID';";
