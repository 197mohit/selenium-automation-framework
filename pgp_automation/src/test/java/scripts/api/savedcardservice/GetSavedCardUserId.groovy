...
@Owner('Deepak')
class GetSavedCardUserId extends TestSetUp {

    def primary

    final def req = { userId ->
        given(
                new RequestSpecBuilder()
                        ...
                        .setBaseUri(PGP_HOST)
                        .setBasePath("/savedcardservice/savedCardService/v1/get/savedcard/userId/${userId}")
                        .build()
        )
    }
