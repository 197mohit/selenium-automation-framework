...
import static com.paytm.appconstants.Constants.Owner.SOURAV
import static io.restassured.RestAssured.given
import static org.hamcrest.Matchers.*

@Owner('Sourav')
@Feature('PGP-37815')
class SSOTokenFetchPayOptionsV5Test extends FetchPayOptionsV5Test {
    ...
    @Override
    @Merchant({it.id == Constants.MerchantType.ADD_MONEY_PCF.getId()})
    @AUser
    @Test
