...
@Owner('Deepak')
class TxnTokenFetchPayOptionsV2Test extends FetchPayOptionsV2Test implements TxnTokenFetchPayOptionsTest {
...
//    @Test(enabled = false)
    ...
    @Owner('Pulkit')
    @Merchant({ it.preferences.isAddNPayWithUPICollect().enabled && it.id == Constants.MerchantType.AddnPay.getId()})
    @AUser(edit = true)
    @Test
    ...
    @Owner('Pulkit')
    @Merchant({ it.preferences.isAddNPayWithUPICollect().enabled && it.id == Constants.MerchantType.AddMoney.getId()})
    @AUser(edit = true)
    @Test
