...
@Owner(DEEPAK)
class TxnTokenFetchMerchantInfoV1Test extends TestSetUp implements FetchMerchantInfoTest, HeadTest {
    ...
    ResponseSpecification resSpec = new ResponseSpecBuilder()
            .expectBody(matchesJsonSchemaInClasspath('json-schemas/fetch-merchant-info-v1-schema.json'))
            .build()
