...
class ChecksumApplyPromoV2Test extends TestSetUp implements ChecksumApplyPromoTest {
    ...
    void 'test when body promocode equals expired promocode'() {
        ...
        req().body(root).post().then()
                .root('body')
                .body(
                        'resultInfo.resultStatus', equalTo('S'),
                        'resultInfo.resultCode', equalTo('00000000'),
                        'paymentOffer.offerBreakup[0].promocodeApplied', equalTo('NOT_VALID_ANYMORE'))
    }
    ...
    void 'test when promo is not valid for payMethod'() {
        ...
        req().body(root).post().then()
                ...
                .body(
                        'resultInfo.resultStatus', equalTo('S'),
                        'resultInfo.resultCode', equalTo('00000000'),
                        'paymentOffer.offerBreakup[0].promocodeApplied', equalTo('NOT_PAY'))
    }
    ...
    void 'test when promo is not valid for mid'() {
        ...
        req().body(root).post().then()
                ...
                .body(
                        'resultInfo.resultStatus', equalTo('S'),
                        'resultInfo.resultCode', equalTo('00000000'),
                        'paymentOffer.offerBreakup[0].promocodeApplied', equalTo('NOT_VALID'))
    }
    ...
    void 'test when promo is not applied by promo engine'() {
        ...
        req().body(root).post().then()
                ...
                .body(
                        'resultInfo.resultStatus', equalTo('S'),
                        'resultInfo.resultCode', equalTo('00000000'),
                        'paymentOffer.offerBreakup[0].promocodeApplied', equalTo('NOT_APPLIED'))
    }
    ...
    void 'test when promo is provided for different bank for which promo is nor created'() {
        ...
        req().body(root).post().then()
                ...
                .body(
                        'resultInfo.resultStatus', equalTo('S'),
                        'resultInfo.resultCode', equalTo('00000000'),
                        'paymentOffer.offerBreakup[0].promocodeApplied', equalTo('NO_BANK'))
    }
