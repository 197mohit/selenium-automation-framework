...
public class GetBankmasterdetailsV1Paymode extends PGPBaseTest {

    @Owner("Anushka")
    @Feature("PG2-12160")
    @Test(description = "Verify GetBankmasterdetailsV1Paymode API response")
    void verifyGetBankmasterdetailsV1Paymode_01() {
        MappingApisPG2 mappingApisPG2=new MappingApisPG2();
        mappingApisPG2.Get_Bankmasterdetails_V1Paymode("NB");
    ...
    @Owner("Anushka")
    @Feature("PG2-12160")
    @Test(description = "Verify GetBankmasterdetailsV1Paymode API bankMasterDetailsList")
    void verifyGetBankmasterdetailsV1Paymode_02() {
        MappingApisPG2 mappingApisPG2=new MappingApisPG2();
        mappingApisPG2.Get_Bankmasterdetails_V1Paymode("NB");
        JsonPath withDrawJson1=mappingApisPG2.execute().jsonPath();
        PG2MappingApisHelper pg2MappingApisHelper=new PG2MappingApisHelper();
