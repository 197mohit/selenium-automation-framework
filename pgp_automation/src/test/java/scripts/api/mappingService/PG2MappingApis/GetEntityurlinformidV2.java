...
public class GetEntityurlinformidV2 extends PGPBaseTest {
    String urlType = "RESPONSE";
    String websiteName = "retail";
    String requestName="qamid";
    @Test
    void verifyGetEntityurlinformidV2api() throws InterruptedException {

        MappingApisPG2 mappingApisPG2=new MappingApisPG2();
        mappingApisPG2.Get_Entityurlinformid_V2(Constants.MerchantType.Mapping_PG2_Attribute.getId().toString(), urlType, websiteName);
        JsonPath withDrawJson1=mappingApisPG2.execute().jsonPath();
        Map<String,String> objectHead= withDrawJson1.getMap("");
        PG2MappingApisHelper pg2MappingApisHelper=new PG2MappingApisHelper();
        pg2MappingApisHelper.verifyGetEntityurlinformidV2(objectHead);
