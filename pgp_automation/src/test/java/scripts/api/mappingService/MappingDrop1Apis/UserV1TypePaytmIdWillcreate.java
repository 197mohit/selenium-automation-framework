...
public class UserV1TypePaytmIdWillcreate extends PGPBaseTest {
    String TYPE1= "PAYTM";
    String TYPE2= "OLDPG";
    ...
    void verifyUserV1TypePaytmId_01() {
        ...
        mappingApisPG2.User_V1_Type_PaytmId_Willcreate(TYPE1, PaytmId, true);
    ...
    void verifyUserV1TypePaytmId_02() {
        ...
        Assert.assertEquals(withDrawJson1.getString("response.oldpgId"), "216810000000889540970");
    ...
    void verifyUserV1TypePaytmId_04() {
        MappingApisPG2 mappingApisPG2=new MappingApisPG2();
        mappingApisPG2.User_V1_Type_PaytmId_Willcreate(TYPE2, PaytmId, true);
        JsonPath withDrawJson1=mappingApisPG2.execute().jsonPath();
        PG2MappingApisHelper pg2MappingApisHelper=new PG2MappingApisHelper();
        Map<String,String> objectHead= withDrawJson1.getMap("");
        pg2MappingApisHelper.VerifyUserV1TypePaytmId(objectHead);
