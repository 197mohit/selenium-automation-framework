...
public class MerchantGetExtendedInfoV3MerchantId extends PGPBaseTest {

    @Owner("Anushka Goldi")
    @Test(description = "Verify MerchantGetExtendedInfoV3 Api resultInfo ")
    void verifyMerchantGetExtendedInfoV3Api_01(){
        MappingApisPG2 mappingApisPG2=new MappingApisPG2();
        mappingApisPG2.Merchant_get_extended_info_V3(Constants.MerchantType.Mapping_PG2_Attribute.getId().toString());
    ...
    @Owner("Anushka Goldi")
    @Test(description = "Verify MerchantGetExtendedInfoV3 Api extendedInfo response ")
...
//    @Owner("Anushka Goldi")
//    @Test(description = "Verify Old and New Api Response of MerchantGetExtendedInfo except alipay keywords parameters")
...
//
//        String ExcludealipayId = " alipayMid:qa12mi80573803805439,";
//        String ExcludeoldpgId = " oldpgMid:qa12mi80573803805439,";
//        String tocompare1= Oldapiresponse.get("extendedInfo").replace(ExcludealipayId, "");
//        String tocompare2= Newapiresponse.get("extendedInfo").replace(ExcludeoldpgId, "");
//        Oldapiresponse.replace("extendedInfo", tocompare1);
//        Newapiresponse.replace("extendedInfo", tocompare2);
//
