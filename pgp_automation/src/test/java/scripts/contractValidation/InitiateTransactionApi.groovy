...
@Owner("Deepak")
class InitiateTransactionApi extends TestSetUp implements ContractTest {
    ...
    final def req = { mId, orderId ->
        given(
                new RequestSpecBuilder()
                        ...
                        .setBaseUri(PGP_HOST)
                        .setBasePath('/theia/api/v1/initiateTransaction')
    ...
    @BeforeClass
    void setUp() {
        DriverManager.getDriver().get('https://developer.paytm.com/docs/initiate-transaction-api/')
