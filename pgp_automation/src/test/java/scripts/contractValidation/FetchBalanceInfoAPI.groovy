...
@Owner("Deepak")
class FetchBalanceInfoAPI extends TestSetUp implements ContractTest {
    ...
    final def req = { mId, orderId ->
        given(
                new RequestSpecBuilder()
                        ...
                        .setBaseUri(PGP_HOST)
                        .setBasePath('/userAsset/fetchBalanceInfo')
    ...
    @BeforeClass
    void setUp() {
        DriverManager.getDriver().get('https://developer.paytm.com/docs/fetch-balance-info-api/')
