 ...
 */
public class CreateMerchantV2Api extends BaseApi {

    private static final String BASE_URI = Constants.ADMIN_SERVER_ADDRESS;
    private static final String BASE_PATH = "/admin/app/api/v2/submitCreateMerchantAPIRequest";

    public CreateMerchantV2Api(CreateMerchant body) {
