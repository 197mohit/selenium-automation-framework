...
/**
 * Created by sureshgupta on 01/12/17.
 */
...
public class FileDownloader {
    ...
    private String localDownloadPath = ExecutionConfig.TEMP_DATA_PATH;
...
//        File downloadedFile = new File(this.localDownloadPath + fileToDownload.getFile().replaceFirst("/|\\\\", ""));
        ...
        Assertions.assertThat(response.getStatusLine().getStatusCode()).as("File Downloading Failed: got status code other than 200").isEqualTo(200);
